...
<?php $this->beginPage() ?>
    ...
    <main role="main" class="flex-shrink-0">
        <div class="container pt-3">
            <?= Breadcrumbs::widget([
                'homeLink'=> ['url'=>'index.php?r=site%2Findex','label'=>'Главная'],
...
<!--                        </p>-->
                    ...
                    <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                        ...
                        <p>
                            <a href="https://51.mchs.gov.ru/" target="_blank" class="text-reset">Управление МЧС МО</a>
                        </p>
                        <p>
                            <a href="https://www.mchs.gov.ru/ministerstvo" target="_blank" class="text-reset">МЧС России</a>
                        </p>
                        <p>
                            <a href="https://murman01.ru/" target="_blank" class="text-reset">Гражданская оборона</a>
                        </p>
                        <p>
                            <a href="https://xn--b1ae4ad.xn--p1ai/virtual" target="_blank" class="text-reset">Виртуальные туры</a>
                        </p>
                    </div>
                    <!-- Grid column -->
