...
<div class="site-about">
    <div class="container pl-5 pr-5 pt-2 pb-5 rounded" style="background-color: #e9ecef">
        ...
        <section class="text-center">
            <iframe src="https://www.mospano.ru/museums/2020/murmansk/" width="100%" height="600"
                    style="border:0; border-radius: 7px; overflow: hidden" allowfullscreen></iframe>
            <div class="bg-dark container-fluid text-white p-2">
                <a href="https://www.mospano.ru/museums/2020/murmansk/" target="_blank"
                   style="color: white; text-decoration: none;">Открыть виртуальный тур в новом окне</a>
            </div>
        </section>
